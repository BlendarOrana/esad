...
// ============ AUTH ============ 
router.post('/auth/register', authCtrl.register); // Implement in authCtrl using bcrypt hashes
...
router.get('/projects/:projectId/magic-link', shareCtrl.getMagicLinkToken);
router.get('/projects/:projectId/pdf', shareCtrl.generateReportPdf);
...
router.post('/maps/:mapId/pins', pinCtrl.createPin);
